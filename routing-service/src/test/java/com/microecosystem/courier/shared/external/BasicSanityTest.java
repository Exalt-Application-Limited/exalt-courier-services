package com.microecosystem.courier.shared.external;
...
/**
 * Basic sanity tests for RoutingService service
...
public class BasicSanityTest {
    ...
    public void applicationPropertiesTest() {
        ...
        String appName = System.getProperty("spring.application.name", "routing-service");
    ...
    public void serviceInitializationTest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            String serviceName = "routing-service";
