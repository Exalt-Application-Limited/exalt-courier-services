package com.gogidix.courierservices.payout.$1.service;
...
import com.gogidix.courierservices.payout.$1.repository.PayoutRepository;
...
public class PayoutServiceTest {
    ...
    void testFindAll() {
        ...
        List<Payout> result = service.findAll();
    ...
    void testFindById() {
        ...
        Optional<Payout> result = service.findById(1L);
    ...
    void testSave() {
        ...
        Payout result = service.save(testEntity);
