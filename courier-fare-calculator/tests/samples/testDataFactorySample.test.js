const { createFare, createMultipleFares } = require('../utils/testDataFactory');

describe('Test Data Factory Usage Sample', () => {
  it('should create a single test entity', () => {
    const entity = createFare();
    expect(entity).toBeDefined();
    expect(entity.id).toBe('1');
  });

  it('should create multiple test entities', () => {
    const entities = createMultipleFares(3);
  ...
  it('should override default values', () => {
    const entity = createFare({ name: 'Custom Name' });
