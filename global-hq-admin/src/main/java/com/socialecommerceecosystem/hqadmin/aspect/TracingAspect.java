package com.gogidix.courier.courier.hqadmin.aspect;
...
public class TracingAspect {
     ...
     */
    @Around("execution(* com.socialecommerceecosystem.hqadmin.service..*.*(..)) && !execution(* com.socialecommerceecosystem.hqadmin.service.TracingService.*(..))")
     ...
     */
    @Around("@annotation(com.socialecommerceecosystem.hqadmin.annotation.Traced)")
